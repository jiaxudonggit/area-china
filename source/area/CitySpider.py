...
class CitySpider(object):
    ...
    def __init__(self, encoding: str, headers: list, provinces: dict, is_multi_thread: bool = False, thread_num: int = 3, sleep: int = 3):
        """
        :param encoding: 编码
        :param headers: 请求头列表
    ...
    def multi_thread(self):
        self.provinces_copy = deepcopy(self.provinces)
